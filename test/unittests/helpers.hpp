...
inline frkhash::hash256 to_hash256(const std::string& hex)
{
    auto parse_digit = [](char d) -> int { return d <= '9' ? (d - '0') : (d - 'a' + 10); };

    frkhash::hash256 hash = {};
...
inline bool operator==(const frkhash::hash256& a, const frkhash::hash256& b) noexcept
{
